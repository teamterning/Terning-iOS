...
func generateDummyData1() -> ScrapsByDeadlineModel {
    let scrapsByDeadline = [
        ...
        MonthlyScrapModel(deadline: "2024-07-05", scraps: [
            ...
            DailyScrapModel(scrapId: 4, title: "데이터 분석 인턴 모집", color: "#00FF00", internshipAnnouncementId: nil, dDay: nil, workingPeriod: nil, companyImage: nil, startYear: nil, startMonth: nil)
        ]),
...
// 더미 데이터 2
func generateDummyData2() -> ScrapsByDeadlineModel {
    let scrapsByDeadline = [
        MonthlyScrapModel(deadline: "2024-07-05", scraps: [
...
func generateDummyData3() -> ScrapsByDeadlineModel {
    let scraps = [
        DailyScrapModel(scrapId: 1, title: "마케팅 인턴 모집", color: "#FF12B4", internshipAnnouncementId: 1, dDay: "D-5", workingPeriod: "3개월", companyImage: "example_logo_1.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 2, title: "개발자 인턴 모집", color: "#FF98F7", internshipAnnouncementId: 3, dDay: "D-5", workingPeriod: "2개월", companyImage: "example_logo_2.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 3, title: "디자인 인턴 모집", color: "#1234FF", internshipAnnouncementId: 4, dDay: "D-6", workingPeriod: "3개월", companyImage: "example_logo_3.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 4, title: "데이터 분석 인턴 모집", color: "#00FF00", internshipAnnouncementId: 5, dDay: "D-7", workingPeriod: "4개월", companyImage: "example_logo_4.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 5, title: "회계 인턴 모집", color: "#0000FF", internshipAnnouncementId: 6, dDay: "D-8", workingPeriod: "6개월", companyImage: "example_logo_5.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 6, title: "영업 인턴 모집", color: "#FFA500", internshipAnnouncementId: 7, dDay: "D-9", workingPeriod: "5개월", companyImage: "example_logo_6.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 7, title: "법률 인턴 모집", color: "#800080", internshipAnnouncementId: 8, dDay: "D-10", workingPeriod: "7개월", companyImage: "example_logo_7.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 8, title: "홍보 인턴 모집", color: "#FFC0CB", internshipAnnouncementId: 9, dDay: "D-11", workingPeriod: "3개월", companyImage: "example_logo_8.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 9, title: "연구 인턴 모집", color: "#008000", internshipAnnouncementId: 10, dDay: "D-12", workingPeriod: "2개월", companyImage: "example_logo_9.url", startYear: 2024, startMonth: 8),
        DailyScrapModel(scrapId: 10, title: "기술 인턴 모집", color: "#000080", internshipAnnouncementId: 11, dDay: "D-13", workingPeriod: "6개월", companyImage: "example_logo_10.url", startYear: 2024, startMonth: 8)
    ]
    let scrapsByDeadline = [MonthlyScrapModel(deadline: "2024-07-01", scraps: scraps)]
    return ScrapsByDeadlineModel(scrapsByDeadline: scrapsByDeadline)
}
